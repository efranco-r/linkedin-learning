...
import sooper.contenedores.imp.Bolsa;
import sooper.contenedores.imp.Caja;
import sooper.productos.IProducto;
import sooper.productos.imp.*;
...
public class Supermecado {
    public static void main(String[] args) {
        ...
        miPedido.addProducto(new Mascota("PER2", 10000, 20000)); // más comida para el perro
        ...
        //miPedido.addProducto(new Drogueria("DET2", 2000, 1600)); // detergente lavadora
        //miPedido.addProducto(new Drogueria("DET3", 2000, 1600)); // detergente lavadora
